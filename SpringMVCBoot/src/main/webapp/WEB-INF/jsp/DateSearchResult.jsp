...
<body>
		...
		<h1 align = center>Purchases for ${Selected_Date} </h1>
...
<c:set var = "dateresult" value = "${Selected_Date}" />

<%
try{String DR = (String)pageContext.getAttribute("dateresult");
connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/springmvcboottest", "root", "12345678");
statement=connection.createStatement();
String sql = "SELECT * FROM purchase_customers_product_rev where purchase_date='"+DR+"'"; 
